...
const ContactForm = () => {
  ...
  return (
    <section
    id='contato'
    className=" w-full flex relative flex-col p-8 h-[580px] justify-center items-center bg-white">
    ...
    <div className="bg-[black]/80 flex flex-col gap-2 relative px-4 rounded-xl border-[#e84620] border justify-center items-center">
         <motion.div
                     ...
                     >
                       <h2 className="text-xl font-[MMC] text-white py-4 uppercase tracking-tighter max-w-[256px]">
                         {t('trabalhe.form')}
                       </h2>
